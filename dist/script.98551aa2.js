...
},{"../deps/cassowary.js":20,"./Expression.js":21}],17:[function(require,module,exports) {
var cassowary  = require('../deps/cassowary.js');
var Expression = require('./Expression.js');
...
},{"../deps/cassowary.js":20,"./Expression.js":21}],22:[function(require,module,exports) {
...
},{"./operators.js":17,"./primitives.js":16}],18:[function(require,module,exports) {
var cassowary       = require('../deps/cassowary.js');
...
},{"../deps/cassowary.js":20,"./primitives.js":16,"./operators.js":17,"./parser.js":22}],14:[function(require,module,exports) {
var global = (1,eval)("this");
var primitives = require('./primitives.js');
var operators  = require('./operators.js');
...
},{"./primitives.js":16,"./operators.js":17,"./System.js":18}],19:[function(require,module,exports) {
var bundleURL = null;
...
var _constrained = require('constrained');

var _constrained2 = _interopRequireDefault(_constrained);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mySystem = new _constrained2.default.System(); //
//
//
//
//
...
exports.default = {
  ...
  methods: {
    ...
    addServerCap: function addServerCap() {
    ...
    addServerCount: function addServerCount() {
    ...
    evaluate: function evaluate() {
      ...
      this.rackCaps.forEach(function (val, ind) {
        ...
        _this.input[label] = val;
        mySystem.addConstant(label, _this.input, label);
      });
      this.serverCaps.forEach(function (val, ind) {
        var label = 's' + (ind + 1) + 'cap';
        _this.input[label] = val;
        mySystem.addConstant(label, _this.input, label);
      });
      this.serverCounts.forEach(function (val, ind) {
        var label = 's' + (ind + 1) + 'count';
        _this.input[label] = val;
        mySystem.addConstant(label, _this.input, label);
      });

      try {
        for (var s = 1; s <= this.servers; s++) {
          for (var r = 1; r <= this.racks; r++) {
            var label = 's' + s + 'r' + r;
            this.output[label] = 0;
        ...
        //Add constraints
        for (var _s = 1; _s <= this.servers; _s++) {
          var _cons = '';
          for (var _r = 1; _r <= this.racks; _r++) {
            _cons += 's' + _s + 'r' + _r + (_r == this.racks ? ' = s' + _s + 'count"' : ' + ');
          }
          console.debug('Going to add Constraint ', _cons);
          mySystem.addConstraint(_cons);
        }
        for (var _r2 = 1; _r2 <= this.racks; _r2++) {
          var _cons2 = '';
          for (var _s2 = 1; _s2 <= this.servers; _s2++) {
            _cons2 += 's' + _s2 + 'r' + _r2 + '*s' + _s2 + 'cap' + (_s2 == this.servers ? ' <= r' + _r2 + 'cap' : ' + ');
          }
          console.debug('Going to add Constraint ', _cons2);
          mySystem.addConstraint(_cons2);
        }
    ...
    outputMat: function outputMat() {
      ...
      if (typeof $454a33 === 'function') {
        $454a33 = $454a33.options;
      }
    
        /* template */
        Object.assign($454a33, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    ...
    _c("table", [
      ...
      _c(
        "tr",
        [
          _c("th", [_vm._v("RUs Available")]),
          _vm._v(" "),
          _vm._l(_vm.racks, function(rack, ind) {
            return _c("th", { key: ind }, [_vm._v("Rack" + _vm._s(rack))])
          }),
          _vm._v(" "),
          _c("th", [
            _vm._v("Rack" + _vm._s(_vm.racks + 1) + " "),
            _c("br"),
            _vm._v("Change to add this Rack")
          ])
        ],
        2
      ),
      ...
      _c(
        "tr",
        [
          _c("td", [_vm._v("RU in each Rack")]),
          _vm._v(" "),
          _vm._l(_vm.racks, function(rack, ind) {
            return _c("td", { key: ind }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model.number",
                    value: _vm.rackCaps[ind],
                    expression: "rackCaps[ind]",
                    modifiers: { number: true }
                  }
                ],
                attrs: { type: "number", min: "0", max: "24" },
                domProps: { value: _vm.rackCaps[ind] },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.rackCaps, ind, _vm._n($event.target.value))
                  },
                  blur: function($event) {
                    _vm.$forceUpdate()
                  }
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model.number",
                  value: _vm.newRackCaps,
                  expression: "newRackCaps",
                  modifiers: { number: true }
                }
              ],
              attrs: { type: "number", min: "0", max: "24" },
              domProps: { value: _vm.newRackCaps },
              on: {
                change: _vm.addRack,
                input: function($event) {
                  if ($event.target.composing) {
                  ...
                  _vm.newRackCaps = _vm._n($event.target.value)
                },
                blur: function($event) {
                  _vm.$forceUpdate()
                }
    ...
    _vm._v(" "),
    _c("table", [
      _c("caption", [_vm._v("Server Inputs")]),
      _vm._v(" "),
      _c(
        "tr",
        [
          _c("th", [_vm._v("Specs")]),
          _vm._v(" "),
          _vm._l(_vm.servers, function(server, ind) {
            return _c("th", { key: ind }, [
              _vm._v("Server Type " + _vm._s(ind + 1))
            ])
          }),
          _vm._v(" "),
          _c("th", [
            _vm._v("Server Type " + _vm._s(_vm.servers + 1)),
            _c("br"),
            _vm._v("Change Value to add new Server Type")
          ])
        ],
        2
      ),
      ...
      _c(
        ...
        [
          _c("td", [_vm._v("Count")]),
          _vm._v(" "),
          _vm._l(_vm.serverCounts, function(server, ind) {
            return _c("td", { key: ind }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model.number",
                    value: _vm.serverCounts[ind],
                    expression: "serverCounts[ind]",
                    modifiers: { number: true }
                  }
                ],
                attrs: { type: "number", min: "0", max: "99" },
                domProps: { value: _vm.serverCounts[ind] },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.serverCounts, ind, _vm._n($event.target.value))
                  },
                  blur: function($event) {
                    _vm.$forceUpdate()
                  }
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model.number",
                  value: _vm.newServerCount,
                  expression: "newServerCount",
                  modifiers: { number: true }
                }
              ],
              attrs: { type: "number", min: "0", max: "99" },
              domProps: { value: _vm.newServerCount },
              on: {
                change: _vm.addServerCount,
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.newServerCount = _vm._n($event.target.value)
                },
                blur: function($event) {
                  _vm.$forceUpdate()
                }
      ...
      _c(
        "tr",
        [
          _c("td", [_vm._v("RUs per Server")]),
          _vm._v(" "),
          _vm._l(_vm.serverCaps, function(server, ind) {
            return _c("td", { key: ind }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model.number",
                    value: _vm.serverCaps[ind],
                    expression: "serverCaps[ind]",
                    modifiers: { number: true }
                  }
                ],
                attrs: { type: "number", min: "1", max: "12" },
                domProps: { value: _vm.serverCaps[ind] },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.serverCaps, ind, _vm._n($event.target.value))
                  },
                  blur: function($event) {
                    _vm.$forceUpdate()
                  }
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model.number",
                  value: _vm.newServerCap,
                  expression: "newServerCap",
                  modifiers: { number: true }
                }
              ],
              attrs: { type: "number", min: "1", max: "12" },
              domProps: { value: _vm.newServerCap },
              on: {
                change: _vm.addServerCap,
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.newServerCap = _vm._n($event.target.value)
                },
                blur: function($event) {
                  _vm.$forceUpdate()
                }
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _vm._l(_vm.outputMat(), function(row, r_ind) {
          return _c(
            "tr",
            { key: r_ind },
            [
              _c("td", [_vm._v("Server Type " + _vm._s(r_ind + 1))]),
              _vm._v(" "),
              _vm._l(row, function(val, c_ind) {
                return _c("td", { key: c_ind }, [_vm._v(_vm._s(val))])
              })
            ],
            2
          )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$454a33', $454a33);
          } else {
            api.reload('$454a33', $454a33);
          }
        }
...
},{"constrained":14,"_css_loader":13,"vue-hot-reload-api":15,"vue":6}],4:[function(require,module,exports) {
"use strict";
...
var _dctool = require("./dctool");

var _dctool2 = _interopRequireDefault(_dctool);
...
},{"vue":6,"./dctool":7}],24:[function(require,module,exports) {
